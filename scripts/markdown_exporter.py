...
def main() -> int:
    ...
    parser.add_argument("--topic", default="study pack builder", help="Topic used in output filename")
    ...
    output = output_dir / f"study_pack_builder_{date}_{slugify(args.topic)}.md"
