...
Study Pack Builder Skill is a Codex skill for English and Japanese language learners who want to turn real study material into practice-ready learning packs. Instead of only translating text, it helps learners understand useful sentences, speak them aloud, review them later, and export them into reusable study formats.
...
Download ZIP:
[https://github.com/estherliu-lab/Study-Pack-Builder-Skill/archive/refs/heads/main.zip](https://github.com/estherliu-lab/Study-Pack-Builder-Skill/archive/refs/heads/main.zip)
...
Study Pack Builder 是一个 Codex skill，中文名是“学习包生成器”。它不是普通翻译器，而是把真实材料拆成可练习的语言学习包：

- 把短文章、台词、字幕文本、SRT/VTT 变成跟读稿
...
```text
请帮我安装这个 Codex skill：
https://github.com/estherliu-lab/Study-Pack-Builder-Skill
...
```powershell
git clone https://github.com/estherliu-lab/Study-Pack-Builder-Skill.git "$env:USERPROFILE\.codex\skills\shadow-speak-skill"
```

macOS / Linux:

```bash
git clone https://github.com/estherliu-lab/Study-Pack-Builder-Skill.git ~/.codex/skills/shadow-speak-skill
```
...
```text
$shadow-speak-skill 帮我把这段英文短文章做成跟读学习包，并生成 Anki CSV：
...
Study Pack Builder Skill is a Codex skill for language learners. It turns short articles, dialogues, subtitle text, SRT/VTT files, English or Japanese passages, and learner-written sentences into practice-ready study material.
...
Study Pack Builder Skill は Codex 用の skill です。短い文章、会話文、字幕テキスト、SRT/VTT、英語・日本語の文章や文を、音読・シャドーイング・復習に使える学習パックへ変換します。
